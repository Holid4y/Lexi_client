        ...
        <div className="px-3 py-2">
          {translations && translations.length > 0 || synonyms && synonyms.length > 0 || meanings && meanings.length > 0 ? (
            <div>
              ...
              <div>
                <span className="pe-2 text-capitalize"><b>{translations[0].text}</b> - {part_of_speech}</span>
              </div>
              <hr />
              <b>Переводы:</b><br />
              ...
              {meanings.map((meaning, index) => (
                <span className="pe-2 text-break word-for-text" key={index}>{meaning.text}</span>
              ))}
            </div>
          ) : (
