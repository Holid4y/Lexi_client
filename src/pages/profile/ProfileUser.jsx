...
function Profile() {
    ...
    const FormTimeToViewResult = (
        <div>
            <span className="ps-2">
                {timeToViewResultState === time_to_view_result ? "Время отображения результата ответа" : "Время отображения результата ответа (не сохранено)"}
            </span>
            <div className="input-group mb-2">
    ...
    // Рендер аватара
    const renderAvatar = () => {
        return <Avatar className="avatar" {...avatarOptions} />;
    };
                ...
                <div className="container pb-5">
                    <div className="row g-4 mb-4 align-items-stretch">
                        <div className="col-4 col-sm-2 d-flex align-items-center position-relative avatar-block">
                            ...
                            <button
                                type="button"
                                className="position-absolute top-0 translate-middle badge rounded-pill bg-primary hover-opacity btn"
