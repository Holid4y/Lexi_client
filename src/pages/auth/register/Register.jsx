      ...
      <main className="form-signin w-100 m-auto">
          <form>
              ...
              <div className="mb-2">
                  ...
                  <input type="text" className="form-control py-2-5" id="login" />
              </div>
              ...
              <div className="mb-4">
                  ...
                  <label for="password2" className="form-label">Повторите пароль</label>
              ...
              <div className="text-center">
                  <a type="submit" className="btn btn-lg btn-primary-auth px-5 mb-2">Регистрация</a>
              </div>
          </form>
      </main>
