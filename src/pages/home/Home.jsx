              ...
              <div className="card text-end bg-card-dark">
                <div className="card-body">
                  <h4 className="card-title text-start">
                    <b>Тренировка слов на сегодня</b>
                  </h4>
