                ...
                <div className="col-12 col-sm-8">
                    <a href="#">
                        <div class="card text-end bg-card-dark">
                            <div class="card-body">
                                <h4 class="card-title text-start">Тренировка слов на сегодня</h4>
                                <p class="text-start mb-0"><span class="book-text">34</span> воспроизведение  <span class="book-text">12</span> узнаваемость</p>
                            </div>
                        </div>
                    </a>
                </div>
