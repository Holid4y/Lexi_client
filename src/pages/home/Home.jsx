        ...
        <main className="container px-4">
            ...
            <div className="row">
                <div className="col-6 col-md-4">
                    <span className="ps-2">Количество слов</span>
                    <div className="card mb-4">
                        <h4 className="book-text text-center py-2">136</h4>
                    </div>
                </div>
                <div className="col-6 col-md-4">
                    <span className="ps-2">Всего текстов</span>
                    <div className="card mb-4">
                ...
                <div className="col-12 col-md-4">
                    <a href="#" className="text-white">
                        ...
                        <div className="card mb-4 w-100 border-none card-btn">
                            <h4 className="book-text text-center py-2"><img src="/assets/images/statistic.svg" height={"40px"} alt="" /></h4>
                        </div>
                    </a>
                </div>
            ...
            <div className="row g-4">
                <div className="col-12 col-sm-8">
                    <a href="#">
                        <div className="card text-end bg-card-dark">
                            <div className="card-body">
                                <h4 className="card-title text-start"><b>Тренировка слов на сегодня</b></h4>
                                <p className="text-start mb-0">
                                    <span className="book-text pe-1">34</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-music-note" viewBox="0 0 16 16">
            ...
            <a href="#">
                <div className="card text-end mb-4 w-100 bg-card-dark">
                    <div className="card-body">
                        <h4 className="card-title w-75 text-start"><b>Книги и тексты</b></h4>
