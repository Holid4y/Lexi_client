  ...
  return (
    <div>
        ...
        <nav className='pagination-position d-flex justify-content-center'>
            <button type="button" className="btn btn-primary mx-2 px-4" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                Добавить книгу
            </button>
        </nav>
                ...
                <div className="modal-content rounded-4 shadow">
                    <div className="modal-body p-5">
                        ...
                        <div className='text-center'>
                            <textarea className="form-control w-100" placeholder='Once upon a time there was a dear little girl...' id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
                        ...
                        <div className="form-check form-switch mt-3">
                            ...
                            <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Приватная книга \ текст</label>
                        </div>

                        <button type="button" className="btn btn-lg btn-primary mt-4 w-100" data-bs-dismiss="modal">Добавить</button>
                    </div>
                </div>
            </div>
        </div>
